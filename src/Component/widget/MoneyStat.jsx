...
function MoneyStat(prop) {
  return (
    <div className="flex w-full h-12 lg:h-24  mb-2 lg:w-96 md:h-16 bg-emerald-100 border-2 border-green-500 rounded-xl transform transition-all hover:-translate-y-1 duration-300 shadow-lg hover:shadow-xl z-1">
